            ...
            <div
                ...
                <div class="flex items-center justify-between px-5 pt-2 pb-4 border-b border-border-subtle shrink-0">
                    <div>
                        ...
                        <div v-if="parentId" class="text-[11px] text-accent mt-0.5">
                ...
                <!-- Body -->
                <div class="px-5 py-5">
                    <input ref="inputRef" v-model="name" type="text" autocomplete="off" spellcheck="false" placeholder="Name des Ortes…"
